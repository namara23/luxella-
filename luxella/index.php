...
$pageTitle = 'Luxella Spaces — Luxury Interior Design & Décor in Uganda';
...
$gallery = [];
$res = @db()->query('SELECT image_path FROM gallery_images ORDER BY sort_order ASC, id DESC');
if ($res) { while ($r = $res->fetch_assoc()) { $gallery[] = $r['image_path']; } }
if (!$gallery) {
...
<section class="hero" id="top">
  <img class="hero-bg" src="<?= BASE_URL ?>assets/images/hero-living.jpg" alt="Luxurious cream and gold living room by Luxella Spaces" width="1920" height="1080">
  <div class="container hero-inner reveal">
    ...
    <p>Curated interior décor, wall art and home accessories — designed to transform houses into sanctuaries across Uganda.</p>
    <div class="hero-ctas">
...
<section id="about" class="section">
  <div class="container about-grid reveal">
    ...
    <div>
      <p class="lead">Luxella Spaces is Uganda's destination for refined interior décor and home styling. We believe a beautifully designed home is more than aesthetics — it's a daily ritual of comfort, calm and confidence.</p>
...
<section id="categories" class="section bg-muted">
  <div class="container">
    <div class="section-head reveal">
      ...
      <a href="<?= BASE_URL ?>shop.php" style="font-size:11px;text-transform:uppercase;letter-spacing:.25em;color:var(--accent)">Browse All →</a>
    </div>
    <div class="cat-grid reveal">
      <?php foreach ($categories as $cat): ?>
        <a href="<?= e(wa_link("I'm interested in your " . $cat['name'] . " collection.")) ?>" target="_blank" rel="noopener" class="cat-card cat-card-aspect">
          <img src="<?= BASE_URL ?>assets/images/<?= e($cat['image']) ?>" alt="<?= e($cat['name']) ?> décor" loading="lazy">
          <div class="body">
  ...
  <div class="container">
    ...
    <div class="gallery-grid reveal">
      <?php foreach ($gallery as $g): ?>
        <div class="g-item"><img src="<?= BASE_URL . e($g) ?>" alt="Luxella interior" loading="lazy"></div>
      <?php endforeach; ?>
    </div>
  </div>
</section>
