...
<meta name="description" content="<?= e($pageDesc ?? 'Luxella Spaces - luxury interior decor, wall art, bathroom & kitchen accessories, living room and bedroom styling. Nationwide delivery across Uganda.') ?>">
...
<meta property="og:image" content="<?= asset_url('assets/images/hero-living.jpg') ?>">
...
"description":"Interior design studio and home decor store in Uganda."}
</script>
</head>
<body>
<header class="nav" id="nav">
  <div class="container nav-inner">
    <a href="<?= url() ?>" class="brand">Luxella<span> Spaces</span></a>
    <ul class="nav-links">
      <li><a href="<?= url('#about') ?>">About</a></li>
      <li><a href="<?= url('#categories') ?>">Collection</a></li>
